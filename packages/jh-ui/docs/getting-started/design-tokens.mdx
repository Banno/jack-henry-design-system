...
For example, to change the value of `--jh-font-body-regular-1` throughout the enture application, you would override the token:

```css
body {
 --jh-font-body-regular-1: var(--jh-font-weight-800) var(--jh-font-size-400)/var(--jh-font-line-height-500) var(--jh-font-family-primary);
}
```
