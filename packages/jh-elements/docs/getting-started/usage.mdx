...
The fonts and related css files are available for download from our [Github Repo - V3](https://github.com/Banno/jack-henry-design-system/tree/release/v3/assets/fonts).
...
```html
<jh-list-item>
  <div slot="jh-list-item-left" class="container">
