...
Download the font and css files from our [Github Repo - V3](https://github.com/Banno/jack-henry-design-system/tree/release/v3/assets/fonts) and store them in the appropriate folder in your project.
