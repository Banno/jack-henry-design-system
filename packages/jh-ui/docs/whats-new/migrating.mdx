...
* All the color tokens in the **rose** family (`--jh-color-rose-50` to `--jh-color-rose-950`) have been deprecated.
* All the color tokens in the **lime** family (`--jh-color-lime-50` to `--jh-color-lime-950`) have been deprecated.
* All the color tokens in the **blue** family (`--jh-color-blue-50` to `--jh-color-blue-950`) have been deprecated.

* All the colors in the **azure** family have been renamed to **blue**: `--jh-color-azure-50` to `--jh-color-azure-950` are now `--jh-color-blue-50` to `--jh-color-blue-950`.
