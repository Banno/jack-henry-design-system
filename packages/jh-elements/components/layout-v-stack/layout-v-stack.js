 ...
 * Layout V Stack
 * 
 * @customElement jh-layout-v-stack
 * @cssprop --jh-layout-v-stack-gap - The space between slotted elements. Defaults to the `--jh-dimension-{gap}` token.
 * @cssprop --jh-layout-v-stack-padding - The padding inside the layout container. Defaults to the `--jh-dimension-{padding}` token.
 * 
...
export class JhLayoutVStack extends JhElement {
  ...
  static get properties() {
    return {
      ...
      /** Determines whether the slotted elements should wrap onto multiple columns. */
...
JhLayoutVStack.register('jh-layout-v-stack', JhLayoutVStack);
