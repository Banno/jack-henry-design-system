...
The Forge Design System maintains a regular release cycle where design and engineering assets are released in coordination. While major versions are synchronized across design and code, minor updates, such as Figma UI kit updates or component code changes, may be released independently.
...
Please review our [release guide](https://github.com/Banno/jack-henry-design-system/blob/release/v2/README.md#release-guide) for more information on our release cadence, types, and phases. 

### Resources

- [Changelog](https://github.com/Banno/jack-henry-design-system/releases)
- [Release Guide](https://github.com/Banno/jack-henry-design-system/blob/release/v2/README.md#release-guide)
