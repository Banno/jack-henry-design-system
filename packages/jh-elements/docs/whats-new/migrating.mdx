...
Version 2 introduces significant changes, including package renaming, token updates, and component refactors.
...
`JhElement` introduces a new event API. The existing payload structures (event.detail) for our component events have been updated, and event listeners will need to use the new property paths below.
...
<table>
  <thead>
    <tr>
      <th>Component</th>
      <th>Event</th>
      <th>Previous Property Path</th>
      <th>New Property Path</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td>`jh-change`</td>
      <td>`e.detail.value`, `e.detail.rawValue`</td>
      <td>`e.detail.state.value`, `e.detail.state.rawValue`</td>
    </tr>
    <tr>
      <td>Input Components</td>
      <td>`jh-input`</td>
      <td>`e.detail.value`</td>
      <td>`e.detail.state.value`</td>
    </tr>
    <tr>
      <td>Input Components</td>
      <td>`jh-input:clear-button-click`
      <br />**Note:** this replaces the `jh-clear` event that was used in V1.</td>
      <td>`e.detail.previousValue`</td>
      <td>`e.detail.state.previousValue`</td>
    </tr>
    <tr>
      <td>Input Components</td>
      <td>`jh-select`</td>
...
#### Updated Input Sizes
To match the new button dimensions, all existing input sizes (`small`, `medium`, and `large`) have been downsized by 8px each.

#### Deprecated Properties and Slots
...
- The `textarea` specific properties have moved to `jh-input-textarea`.
- The `password` specific properties and slots have moved to `jh-input-password`.
...
<table>
  ...
  <tbody>
    <tr>
      <td>--jh-input-border-radius</td>
      <td>--jh-input-field-border-radius</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>--jh-input-color-background</td>
      <td>--jh-input-field-color-background</td>
    </tr>
    <tr>
      <td>--jh-input-color-border-active</td>
      <td>--jh-input-field-color-border-active</td>
    </tr>
    <tr>
      <td>--jh-input-color-border-disabled</td>
      <td>--jh-input-field-color-border-disabled</td>
    </tr>
    <tr>
      <td>--jh-input-color-border-enabled</td>
      <td>--jh-input-field-color-border-enabled</td>
    </tr>
    <tr>
      <td>--jh-input-color-border-error</td>
      <td>--jh-input-field-color-border-error</td>
    </tr>
    <tr>
      <td>--jh-input-color-border-focus</td>
      <td>--jh-input-field-color-border-focus</td>
    </tr>
    <tr>
      <td>--jh-input-color-border-hover</td>
      <td>--jh-input-field-color-border-hover</td>
    </tr>
    <tr>
      <td>--jh-input-color-text</td>
      <td>--jh-input-value-color-text</td>
    </tr>
    <tr>
      <td>--jh-input-left-icon-color-fill</td>
      <td>--jh-icon-color-fill</td>
    </tr>
    <tr>
      <td>--jh-input-placeholder-color-text</td>
      <td>Deprecated along with the <code>placeholder</code> property</td>
    </tr>
    <tr>
      <td>--jh-input-right-icon-color-fill</td>
      <td>--jh-icon-color-fill</td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>CSS Hook</td>
      <td>Migrate to `--jh-list-item-color-text-primary-enabled`.</td>
    </tr>
    <tr>
      <td>`--jh-list-item-color-text-primary`</td>
      <td>CSS Hook</td>
      <td>Migrate to `--jh-list-item-color-text-primary-enabled`.</td>
    </tr>
    <tr>
...
For full implementation details, visit the [`jh-list-item` layouts documentation](?path=/docs/components-list-item--docs#layouts). 
