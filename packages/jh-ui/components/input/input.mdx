...
<div style={{border: '1px solid #76b4f8', backgroundColor: '#ecf5fe', padding: '1rem', borderRadius: '0.25rem', marginBottom: '1rem'}}>
### Migration Required
The `<jh-input>` component has been refactored into a base class and the `type` property has been deprecated.
Specialized types are now separated into the following discrete components:
- `jh-input` (base component)
- `jh-input-search`
- `jh-input-password`
- `jh-input-textarea`
- `jh-input-email`
...
See the [Component API](#component-api) below for details on all deprecated properties, slots, and styling hooks.
See our Migration Guide for more details on how to update your code: [Migration Guide](https://release-v2--68f8e6a25b256d0ef89b13e6.chromatic.com/?path=/docs/what-s-new-migrating--docs).
</div>
