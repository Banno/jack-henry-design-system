...
const deprecations = {
  ...
  'jh-list-item': {
    slots: {
      'jh-list-item-content': 'Use the available properties or the `default` slot with `jh-list-item-left` and `jh-list-item-right` slots instead.',
      'jh-list-item-metadata': 'Use `primary-metadata` and `secondary-metadata` properties or the `default` slot with `jh-list-item-left` and `jh-list-item-right` slots instead.',
    },
    cssProperties: {
