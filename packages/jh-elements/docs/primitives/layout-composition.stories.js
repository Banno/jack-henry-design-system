...
import '../../components/layout-hstack/layout-hstack.js';
import '../../components/layout-vstack/layout-vstack.js';
...
export const Toolbar = {
  render: () => html`
    <jh-layout-hstack class="demo-surface" padding="200" gap="100" align="center">
...
/**
 * Nested stacks — a vstack whose rows are hstacks.
 * Demonstrates that the primitives compose because each is just a flex container.
 */
export const CardLayout = {
  render: () => html`
    <jh-layout-vstack class="demo-surface" padding="300" gap="200">
      <jh-layout-hstack gap="100" align="center">
      ...
      <jh-layout-hstack gap="100" justify="end">
...
/**
 * Form row — a vstack of labeled hstacks, using align to keep labels and
 * controls on a shared baseline.
 */
export const FormRow = {
  render: () => html`
    <jh-layout-vstack class="demo-surface" padding="300" gap="200">
      <jh-layout-hstack gap="200" align="baseline">
...
/**
 * Wrapping — an hstack with wrap so children reflow onto new lines when the
 * container runs out of room. Resize the canvas to see the reflow.
 */
export const Wrapping = {
  render: () => html`
    <jh-layout-hstack class="demo-surface" padding="200" gap="100" wrap>
...
/**
 * Larger form — a vstack of stacked inputs followed by an hstack that places
 * two distinct checkbox-groups side by side, ending in a spacer-aligned action
 * row. Shows the primitives scaling up to a full form layout.
 */
export const Form = {
  render: () => html`
    <jh-layout-vstack class="demo-surface" padding="300" gap="300">
      <strong>Create account</strong>

      <jh-layout-vstack gap="200">
