...
The Forge Design System uses the variable fonts **Roboto Flex** as its main font and **Roboto Mono** for monospace text (see [Typography](https://jackhenry.design/v2/foundations/typography/) details).
...
Download the font and css files from our [Github Repo - V2](https://github.com/Banno/jack-henry-design-system/tree/release/v2/assets/fonts) and store them in the appropriate folder in your project.
...
To set the font-family for all or selected elements that are not part of the Forge Design System, set the `font-family` property to your custom font in your main stylesheet.
