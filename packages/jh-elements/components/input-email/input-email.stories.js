...
export const Overview = { render: (args) => html`
  <div class="overview-story">
    <jh-input-email label="Label" helper-text="Helper text"></jh-input-email>
    <jh-input-email label="Label" error-text="Error message" invalid></jh-input-email>
  </div>
`};
...
export const Playground = { render: (args) => html`
  ...
  Playground.args = {
    ...
    'helper-text': 'Enter a valid email address (e.g., name@example.com)',
    'hide-left-slot': false,
    'hide-right-slot': false,
    'accessible-label': null,
    'accessible-label-clear-button': 'clear email input',
    maxlength: null,
    minlength: null,
    autocomplete: null,
    inputmode: null,
