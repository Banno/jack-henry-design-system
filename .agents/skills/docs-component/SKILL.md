...
- Build a `docs/foundations/<slug>.md` page for one Forge foundation category.
- Content MUST always come from the foundation spec files. It MUST NOT come from the live site, Storybook, or invention.
...
1. **`../docs-general/SKILL.md`:** The general skills needed for creating documentation pages.
2. **`/DESIGN.md`:** The system's foundational guidelines.
