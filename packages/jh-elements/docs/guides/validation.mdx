...
- `static groupComponent = true;`. This static property signals to the validation mixin that the component is a control group and should be validated using group-specific rules based on its children's states.
