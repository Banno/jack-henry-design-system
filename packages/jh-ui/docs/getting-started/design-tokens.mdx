...
Design tokens are fundamental to the Forge Design System and serve as the single source of truth for our visual design attributes. They are named entities that store specific values, such as colors, typography, and spacing, in a platform-agnostic format.
...
Explore our [Design Tokens documentation](https://jackhenry.design/pages/foundations/design-tokens/overview/) for a deeper dive into design tokens and the Forge Design System.