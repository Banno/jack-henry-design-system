...
All components now officially extend from `JhElement`. This new underlying base class drives better code reuse and allows dependencies to be shared efficiently across the library. 
