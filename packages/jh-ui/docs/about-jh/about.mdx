...
Our design system, including all components, design tokens, and source code, is licensed under the **Apache License, Version 2.0**.

Please see the complete [license file](https://github.com/Banno/jack-henry-design-system/blob/next/LICENSE) for full legal details.