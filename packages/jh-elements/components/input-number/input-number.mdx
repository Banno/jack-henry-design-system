...
[Guidelines](https://jackhenry.design/pages/components/input-number/)
...
To use `<jh-input-number>`: *can include details about slot or anything relevant. Keep this short as it is just a code snippet to get the author started.* 
...
For boolean attributes, true indicates that the attribute has been set without a value: `<jh-input-number add-relevant-boolean></jh-input-number>`. While false indicates the attribute does not exist in the DOM: `<jh-input-number></jh-input-number>`.
