...
The Forge Design System uses the variable fonts **Roboto Flex** as its main font and **Roboto Mono** for monospace text (see [Typography](https://jackhenry.design/pages/foundations/typography/) details).
