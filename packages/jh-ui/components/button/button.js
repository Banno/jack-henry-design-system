 ...
 * @cssprop --jh-button-color-border-secondary-enabled - The button container border-color when enabled and `appearance="secondary"`. Defaults to `--jh-color-content-brand-enabled`.
 ...
 * @cssprop --jh-button-color-border-secondary-disabled - The button container border-color when disabled and `appearance="secondary"`. Defaults to `--jh-color-content-brand-enabled`.
 ...
 * @cssprop --jh-button-color-border-secondary-pending - The button container border-color when pending and `appearance="secondary"`. Defaults to `--jh-color-content-brand-enabled`.
 ...
 * @cssprop --jh-button-shadow-focus - The button container box-shadow when in focus. Defaults to `--jh-shadow-focus`.
 * @cssprop --jh-button-size - The button width when no label is set, and the button height. Button width and height defaults to `--jh-size-1000` when `size="small"`, `--jh-size-1200` when `size="medium"`, and `--jh-size-1400` when `size="large"`. 
 *
...
export class JhButton extends LitElement {
  ...
  static get styles() {
    return css`
      ...
      :host(:not([block])) {
        /* Prevent expansion in grid layouts — override author styles */
        width: fit-content;
        /* Prevent flex-based stretching — override author styles */
        flex: 0 0 auto !important;
      }
      :host([block]) {
        display: block;
        text-align: center;
        /* Ensures button expands to fill its grid cell — overrides author alignment */
      ...
      a:focus-visible {
        box-shadow: var(--jh-button-shadow-focus, var(--jh-shadow-focus));
      }
      :host([pending]),
      ...
      :host([size='small']) a {
        height: var(--jh-button-size, var(--jh-size-1000));
      }
      :host([size='medium']) button,
      :host([size='medium']) a {
        height: var(--jh-button-size, var(--jh-size-1200));
      }
      :host([size='large']) button,
      :host([size='large']) a {
        height: var(--jh-button-size, var(--jh-size-1400));
      }
      ...
      :host([pending]) button:focus,
      :host([pending]) a:focus {
        box-shadow: none;
      }
      /* pending styling */
      :host([pending]) button,
      ...
      /* Icon only styling */
      :host(:not([label]):not([block])[size='small']) button,
      :host(:not([label]):not([block])[size='small']) a {
        width: var(--jh-button-size, var(--jh-size-1000));
      }
      :host(:not([label]):not([block])[size='medium']) button,
      :host(:not([label]):not([block])[size='medium']) a {
        width: var(--jh-button-size, var(--jh-size-1200));
      }
      :host(:not([label]):not([block])[size='large']) button,
      :host(:not([label]):not([block])[size='large']) a {
        width: var(--jh-button-size, var(--jh-size-1400));
      }
  ...
  static get properties() {
    return {
      ...
      /** Expands the button to fill the width of its parent container. When false, button width is intrinsic and does not respond to container size. */
      block: {
        type: Boolean,
      },
