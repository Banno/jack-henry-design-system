...
```javascript
import '@jack-henry/jh-ui/components/<%= unprefixedName %>/<%= unprefixedName %>.js';
```
...
an issue on [GitHub](https://github.com/Banno/jack-henry-design-system-ui/issues).

Engage with the community on our [GitHub discussion board](https://github.com/Banno/jack-henry-design-system-ui/discussions).