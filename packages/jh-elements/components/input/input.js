...
export class JhInput extends LitElement {
  ...
  renderLeftSlot() {
    ...
    return html`
      <div class="slot-wrapper slot-left">
        <slot name="jh-input-left" @slotchange=${this.#handleSlotChange}>blabalab</slot>
      </div>
    `;
  }
  ...
  renderRightSlot() {
    ...
    return html`
      <div class="slot-wrapper slot-right">
        <slot name="jh-input-right" @slotchange=${this.#handleSlotChange}>
          <jh-button 
            size="small" appearance="tertiary"
