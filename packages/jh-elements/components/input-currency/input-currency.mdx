...
[Guidelines](https://jackhenry.design/pages/components/input-currency/)
...
To use `<jh-input-currency>`: *can include details about slot or anything relevant. Keep this short as it is just a code snippet to get the author started.* 
...
For boolean attributes, true indicates that the attribute has been set without a value: `<jh-input-currency add-relevant-boolean></jh-input-currency>`. While false indicates the attribute does not exist in the DOM: `<jh-input-currency></jh-input-currency>`.
