 ...
 * @cssprop --jh-checkbox-input-shadow-focus - The checkbox box shadow when focused. Defaults to `--jh-shadow-focus`.
 ...
 * @cssprop --jh-checkbox-input-color-border-unselected-enabled - The checkbox border-color when unselected. Defaults to `--jh-color-divider-primary`.
 ...
 * @cssprop --jh-checkbox-input-color-border-unselected-disabled - The checkbox border-color when unselected and disabled. Defaults to `--jh-color-divider-primary`.
  ...
  static get styles() {
    return css`
      ...
      input:focus-visible + span {
        ...
        box-shadow: var(
          --jh-shadow-focus-color-content-brand-hover,
          var(--jh-shadow-focus)
        );
      }
      input:hover + span {
