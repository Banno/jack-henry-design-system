...
Dividers are used to group content vertically or horizontally at the page or component level and should be used when whitespace does not provide a clear enough separation. 
